...
class Item(object):
    ...
    def __init__(self, attributes, title, subtitle, subtitleCmd = None, icon=None):
        self.attributes = attributes
        self.title = title
        self.subtitle = subtitle
        self.subtitleCmd = subtitleCmd
        self.icon = icon
    ...
    def xml(self):
        ...
        if self.subtitleCmd != None:
            SubElement(item, u'subtitle', self.unicode({'mod' : 'cmd'})).text = self.subtitleCmd
        return item
